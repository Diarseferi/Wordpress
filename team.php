<?php 
// Template Name: Team(Post Category)
        ...
        <li class="team-card">
            ...
            <div class="team-info">
                ...
                <?php if(has_excerpt()):?>
                    ...
                    <?php elseif($shortbio):?>
                            <p class="team-bio"><?php echo(ecs_html($shortbio));?></p>
                    <?php endif; ?>

                <?php if($email || $linkedin): ?>
                    <p class="team-links">
                        <?php if($email):?>
                            <a href="mailto: <?php echo antispambot($email);?>">Email</a> <?php endif;?>
                        <?php if($linkedin): ?>
                        <a href="<?php echo esc_url($linkedin);?>" rel="noopener">Linkedin</a><?php endif;?>
                    </p>
                    <?php endif;?>
            </div>
        </li>
